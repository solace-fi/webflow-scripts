...
// @ts-check
System.register("tsTesting/listHeaderSorters", [], function (exports_2, context_2) {
    "use strict";
    var currentSort, arrows, clientDirections, serverDirections, serverToClientDirection, clientToServerDirection, nestedArrows, sortFunctions;
    ...
    /** @type {import('../types').SortDirection} */ direction) {
        return sort.some((s) => s.sorteable === sorteable && s.direction === direction);
    }
    ...
    /** @type {import('../types').SortDirection} */ direction) {
        ...
        const sortHasOppositeDirection = currentSort.some((s) => s.sorteable === sorteable && s.direction === oppositeDirection);
        currentSort.forEach((s, i) => {
    ...
    /** @type {SortDirection} */ direction) {
        ...
        /** @type {Protocol[]} */
        const sortedList = protocols.sort(sortFunctions[sorteable][direction]);
        return sortedList;
    }
    /* sort the list according to the current sort */
    ...
    /** @type {MappedProtocol[]} */ protocols) {
        ...
        protocols.forEach((protocol) => {
            ...
            const protocolCategory = protocolElement.querySelector(".protocol_category");
    ...
    /** @type {Protocol[]} */ protocols) {
        ...
        const mappedProtocols = protocols.map((/** @type {Protocol} */ protocol) => {
            ...
            const child = $(children).find(`:contains(${processProtocolName(protocol.appId)})`);
    ...
    return {
        ...
        execute: function () {
            ...
            */
            ...
            clientDirections = ["up", "down"];
            serverDirections = ["asc", "desc"];
            serverToClientDirection = (direction) => {
            ...
            */
            ...
            $(document).ready(async function () {
                ...
                const mappedProtocolList = mapProtocolsToHtmlElements($(".protocol_list"), sortedList);
